...
func TestRob(t *testing.T) {
	tests := []struct {
		...
		{[]int{2, 7, 9, 3, 1}, 12},
		{[]int{2, 1, 1, 2}, 4},
		{[]int{1, 2, 3, 1, 1, 100}, 104},
		{[]int{1, 2, 3, 1, 1, 100, 1}, 104},
		{[]int{1, 2, 3, 1, 1, 100, 1, 1}, 105},
		{[]int{1, 2, 3, 1, 1, 100, 1, 1, 1}, 105},
		{[]int{1, 2, 3, 1, 1, 100, 1, 1, 1, 1}, 106},
		{[]int{1, 2, 3, 1, 1, 100, 1, 1, 1, 1, 1}, 106},
		{[]int{1, 2, 3, 1, 1, 100, 1, 1, 1, 1, 1, 1}, 107},
		{[]int{1, 2, 3, 1, 1, 100, 1, 1, 1, 1, 1, 1, 1}, 107},
		{[]int{1, 2, 3, 1, 1, 100, 1, 1, 1, 1, 1, 1, 1, 1}, 108},
		{[]int{1, 2, 3, 1, 1, 100, 1, 1, 1, 1, 1, 1, 1, 1, 1}, 108},
